...
@bot.on_message(filters.command("stop") & (filters.chat(LOG)))
async def restart_handler(_, m):
    await m.reply_text("**Oh! Fuck 🚨**", True)
    os.execl(sys.executable, sys.executable, *sys.argv)


@bot.on_message(filters.command("txt") & (filters.chat(LOG)))
            ...
            try:  
                ...
                if "drive" in url:
                    try:
                        ...
                        await bot.send_document(m.chat.id,document=ka, caption=cc1)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
                    ...
                    try:
                        ...
                        await bot.send_document(m.chat.id,document=f'{name}.pdf', caption=cc1)
                        count += 1
